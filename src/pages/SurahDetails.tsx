      ...
      {loading ? (
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div 
              className="quran-text text-justify leading-[2.2] space-x-reverse"
            ...
            >
              ...
              {!isFocusMode && surahMetadata.number !== 9 && (
                <div className="mb-4 text-center border-b border-primary/10 pb-3">
                  {surahMetadata.number === 1 ? (
                    <span className="block text-3xl mb-2 font-black text-primary dark:text-emerald-400">
