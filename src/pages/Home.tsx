...
export default function Home() {
  ...
  return (
    <div className="pb-32 pt-30 px-6 max-w-2xl mx-auto">
        ...
        <header className="glass rounded-2xl px-6 py-4 flex items-center justify-between max-w-2xl mx-auto card-shadow">
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-[10px] text-black/60 dark:text-slate-400 font-medium">دليلك لرحلة بين آيات القرآن والقصص</p>
            </div>
          </div>
      ...
      <section className="mb-6">
        <div className="glass px-4 py-3 rounded-2xl card-shadow mb-6 overflow-hidden relative">
          <div className="relative z-10 flex flex-col items-center w-full">
            <p className="text-[10px] font-bold text-primary dark:text-emerald-400 mb-1">آية اليوم</p>
            <QuranVerse text={dailyVerseText} className="!my-0.5 !text-2xl" />
